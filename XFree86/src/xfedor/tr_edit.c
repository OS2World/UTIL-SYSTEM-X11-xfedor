...
void Autom_edit() ;
void Afficher_resol() ;
void Afficher_colors() ;
void Afficher_sos();
void Afficher_boutons();
void Afficher_numview();
static void Afficher_modcolor() ;
static void Afficher_modecour() ;
...
void Afficher_colors()      /* pas static pour tr_colormap */
{
...
static void Afficher_modcolor(onoff)
	int onoff ;
{ 
	int xoffset ;
...
void Afficher_boutons(gauche,milieu)
     char * gauche, * milieu;
{	
