...
void Rast_Init(climag,w,h,flag)
/************************/
...
void Rast_Copy(sourceimage,destimage)
/******************************/
/* 128x128 only , format MSB/pad8 only */
...
void Rast_Mem(climap,w,h,pmem,pwidth)
/******************************/
...
void Rast_Pix(climag,x,y,color)
/************************/
	ClientImage* climag ;
	int x,y ;
	int color ;
...
int Ligne_color(climag,y,x1,x2,color)
/*******************************/
	ClientImage * climag ;
	int y,x1,x2 ;
	int color ;
...
int Colonne_color(climag,x,y1,y2,color)
/*********************************/
	ClientImage * climag ;
	int x,y1,y2 ;
	int color ;
...
void Rast_Op(sourceimage,destimage, x1,y1,x2,y2,w,h, mode, color)
/**********************************************************/
	ClientImage * sourceimage, * * destimage ;
	int x1,y1,x2,y2 ;
	int w,h ;
...
void Rast_Op_1n(sourceimage,destimage, x1,y1,x2,y2,w,h, mode, colorcur)
/****************************************************************/
...
void Rast_Op_n1(sourceimage,destimage, x1,y1,x2,y2,w,h, mode, colorback)
/*****************************************************************/
